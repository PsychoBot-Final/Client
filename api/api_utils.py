...
def load_templates(dir_name: str) -> dict:
    """
    The function `load_templates` loads image templates from a specified directory and stores them in a
    dictionary.
    
    Args:
      dir_name (str): The `dir_name` parameter is a string that represents the name of the directory
